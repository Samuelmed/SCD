...
// Modificado por: Samuel Medina Gutiérrez
//   Datos de las tareas:
//   ------------
//   Ta.  T    C
//   ------------
...
// Modificado en Diciembre de 2018
// -----------------------------------------------------------------------------
...
int main( int argc, char *argv[] )
{
   ...
   time_point<steady_clock> ini_fin;
   ...
   while( true ) // ciclo principal
   {
      ...
      for( int i = 1 ; i <= 4 ; i++ ) // ciclo secundario (4 iteraciones)
      {
         ...
         steady_clock::duration diferencia = ini_fin - ini_sec;
         cout << "El tiempo restante de retraso es de es de " << milliseconds_f(diferencia).count() << "Milisegundos." << endl;
         if(diferencia>milliseconds_f(20.0)){
           cout<<"Demasiado tiempo.";
           exit(0);
         }
